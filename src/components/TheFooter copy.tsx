  ...
  return (
    <div className="bg-slate-800 text-gray-300 pt-20 text-sm font-normal">
      <div className="container mx-auto">
            ...
            <div className="flex flex-col gap-10">
              ...
              <div className="flex flex-col gap-3">
                ...
                <div className="flex flex-col gap-3">
                  <div className="inline-flex gap-x-4 items-center">
                    ...
                    <span>+01-5454439, 9767658794</span>
                  </div>
                  <div className="inline-flex gap-x-4 items-center">
              ...
              <div className="flex flex-col gap-3">
                ...
                <div className="flex gap-5">
                  <a className="inline-flex gap-x-4 items-center" href="https://www.facebook.com/nextskillsacademy">
                    <svg
                      xmlns="http://www.w3.org/2000/svg"
                      width="16"
                      height="16"
                  ...
                  <a className="inline-flex gap-x-4 items-center" href="https://wa.me/9779767658794" target="_blank">
                    <svg
                      xmlns="http://www.w3.org/2000/svg"
                      width="16"
                      height="16"
        ...
        <div className="flex flex-wrap gap-3 items-center pt-2 pb-4">
          <span>
