...
const LandingPage = () => {
  ...
  return (
    <div className="">
      <div className="grid lg:grid-cols-2 gap-20 py-10">
        <div className="grid grid-cols-3 gap-5">
          <div className="col-span-1">
            <div className="h-[120px] flex bg-slate-100 rounded-2xl mb-5 flex-col  justify-center p-5">
              <span className="text-gray-500 text-3xl font-semibold">10+</span>
              <span className="text-gray-400 text-base">
                Qualified Teachers
              </span>
            </div>
            <div className="md:h-[260px] h-[160px] flex bg-yellow-500/70 rounded-2xl">
              <Image
                src="/images/img1.png"
                alt="Hero image"
          ...
          <div className="col-span-2">
            <div className="lg:h-[200px] h-[160px] flex bg-blue-50 rounded-2xl mb-5 overflow-hidden">
              <Image
                src="/images/img2.jpg"
                alt="Hero image"
            ...
            <div className="md:h-[180px] h-[120px] flex flex-col bg-blue-100 rounded-2xl p-5 gap-1">
          ...
          <div className="col-span-2 bg-slate-100 h-[160px] rounded-2xl p-5 relative">
            <p className="mt-2">
          ...
          <div className="col-span-1 bg-yellow-500/40 h-[160px] rounded-2xl flex items-center justify-center">
            <Image
              src="/images/like.png"
              alt="Hero image"
      ...
      <div className="min-h-screen w-full flex flex-col py-20 items-center">
        <div className="flex flex-col gap-5 justify-center items-center mt-10 mb-12">
          <h3 className="text-4xl font-semibold mb-2">Explore Our Offerings</h3>
          <div className="flex flex-wrap gap-3 justify-center">
            {
              coursesChips.map(elem => (
                <span key={elem.id} className="px-5 py-1 border rounded-full bg-gray-50 border-gray-200 text-gray-500">{elem.name}</span>
              ))
            }
          </div>
        </div>
      ...
      <div className="bg-blue-50 rounded-2xl grid lg:grid-cols-5 overflow-hidden lg:p-10 p-5 gap-20">
        <div className="col-span-3 ">
          ...
          <p className="text-gray-500 text-lg mb-14">Lorem ipsum dolor sit amet consectetur adipisicing elit. Porro maiores reprehenderit assumenda in debitis labore neque ipsam illo itaque hic pariatur doloremque repellendus architecto eos, expedita quo nulla minus vel qui at sit ducimus culpa eveniet recusandae. Aliquam soluta iure ad perspiciatis at! Labore numquam placeat beatae nesciunt!
          </p>
